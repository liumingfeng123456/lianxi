			...
			<div id="navbar-menu">
				<ul class="nav navbar-nav navbar-right">
					<li><a class="update-pro" href="Initialization" title="Login"><i
							class="fa fa-rocket"></i> <span>登录</span></a></li>
				</ul>
			</div>
		</div>
		</nav>
					...
					<div class="panel">
						<div class="panel-heading">
							...
							<div class="logo text-center">
								<img src="assets/img/true.png" alt="BiblioSoft Logo">
								<br />
								<br />
								<h1>推荐书籍</h1>
							</div>
						...
						<div class="panel-body">
							<table align="center" style="text-align: center">
								<tr>
									<td width="350px"><h3>诗歌</h3></td>
									<td width="350px"><h3>白话小说</h3></td>
									<td width="350px"><h3>长篇小说</h3></td>
								</tr>
								<tr>
