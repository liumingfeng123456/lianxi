													...
													<c:if test="${book.state=='inlib'}" var="flag">
														<th><form method="post" action="AddBookToCart">
																...
																<button type="submit" name="addtocart"
																	class="btn btn-success">加入借阅车</button>
															</form></th>
													</c:if>
													<c:if test="${not flag}">
														<th></th>
