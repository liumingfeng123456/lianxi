	...
	<div class="sidebar-scroll">
		...
		<ul class="nav">
			<li><a href="librarianHomepage.jsp" class=""> <i
					class="lnr lnr-home"></i> <span>图书管理员主页</span>
			</a></li>
			...
			<li><a href="#subPages1" data-toggle="collapse"
				class="collapsed"><i class="lnr lnr-cog"></i> <span>管理
						图书</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
				<div id="subPages1" class="collapse">
					<ul class="nav">
						...
						<li><a href="librarianReturnBook.jsp" class="">返回图书</a></li>
					</ul>
				</div></li>

			<li><a href="#subPages2" data-toggle="collapse"
				class="collapsed"><i class="lnr lnr-cog"></i> <span>管理读者
				...
				<div id="subPages2" class="collapse">
					<ul class="nav">
						...
						<li><a href="librarianSearchReader.jsp" class="">搜寻读者</a></li>
						<li><a href="librarianLendBook.jsp" class="">借书给读者</a></li>
						<li><a href="ShowCart?start=0" class="">显示借用车</a></li>
					</ul>
				</div></li>

			<li><a href="#" onclick="logout()" class=""> <i
					class="lnr lnr-linearicons"></i> <span>退出</span>
			</a></li>
		</ul>
		</nav>
	</div>
