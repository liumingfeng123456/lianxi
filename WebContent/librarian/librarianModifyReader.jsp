		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">图书管理员修改读者信息</h3>
					<div class="row">
						<!-- BASIC TABLE -->
						<div class="panel">
								...
								<form method="post" onsubmit="return inputCheck(this)"
									...
									<table align="center">
										<tr>
											<td width=150px height=64px>
												<div class="form-group has-success has-feedback">
													<label class="control-label" for="readerID">读者
														ID</label>
												</div>
											</td>
										...
										<tr>
											<td width=150px height=64px>
												<div class="form-group has-success has-feedback">
													<label class="control-label" for="readerName">读者名字</label>
												</div>
											</td>
											<td width=350px height=64px>
												<div class="form-group has-success has-feedback">
										...
										<tr>
											...
											<td width=350px height=64px>
												...
												<c:if test="${readerEntity.state eq 'unlock'}">
													<input type="radio" name="state" value="blockade" />加锁
													<input type="radio" name="state" value="unlock" checked />解锁
												</c:if> <c:if test="${readerEntity.state eq 'blockade'}">
													<input type="radio" name="state" value="blockade" checked />加锁
