		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">查询 读者</h3>
					<div class="row">
						<!-- BASIC TABLE -->
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">图书管理员搜索阅读者</h3>
							</div>
									...
									<table align="center">
										<tr>
											<td width=250px height=64px>
												<div class="form-group has-success has-feedback">
													<label class="control-label" for="readerName">读者
														ID</label>
												</div>
											</td>
										...
										<tr>
											...
											<td width=350px height=64px><input type="radio"
												name="state" value="unlock" />解 锁 <input type="radio"
												name="state" value="blockade" />加锁<input
								...
								<c:if test="${not empty readerEntity }">
									<table align="center" class="table">
										...
										<tr>
											...
											<td><a
												href="ShowReaderInfo?reader_id=${readerEntity.id }&param=cart">详细</a></td>
											<td><a
												href="ShowReaderInfo?reader_id=${readerEntity.id }&param=history">详细</a></td>
											<td><a
												href="ShowReaderInfo?reader_id=${readerEntity.id }&param=current">详细</a></td>
										</tr>
									</table>
								</c:if>
									...
									<table align="center" class="table">
										...
										<c:forEach var="reader" items="${readerList }" varStatus="i">
											<tr>
												...
												<td>${reader.state }</td>
												<td><a
													href="ShowReaderInfo?reader_id=${reader.id }&param=cart">详细</a></td>
												<td><a
													href="ShowReaderInfo?reader_id=${reader.id }&param=history">详细</a></td>
												<td><a
													href="ShowReaderInfo?reader_id=${reader.id }&param=current">详细</a></td>
											</tr>
										</c:forEach>
									</table>
								</c:if>
