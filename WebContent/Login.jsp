							...
							<form class="form-auth-small" method="post" action="LoginHandler">
								<table align="center">
									...
									<tr>
										...
										<td>
											<div class="form-group clearfix" align="left">
												...
												<input type="radio" name="authority" value="reader" checked />读者 <br />
												<input type="radio" name="authority" value="librarian" />图书馆员 <br />
												<input type="radio" name="authority" value="administrator" />管理员 <br />
												</c:if>
									...
									<tr>
										...
										<td>
											<div class="form-group clearfix" align="left">
												<input type="checkbox" name="isRemember" id="isRemember"/>记住密码
											</div>
										</td>
									</tr>
									<tr>
